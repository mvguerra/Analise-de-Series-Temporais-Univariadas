...
sarima(df1[,2],0,0,0,2,1,2,12) #BIC=4652.76
...
# Teste de Ljung-Box dos resíduos do modelo selecionado
...
# Portanto, segundo o teste de Ljung-Box, não se rejeita a hipótese que os resíduos se comportam como um ruído branco.

# Teste de Jarque-Bera dos resíduos do modelo selecionado
...
# Portanto, segundo o teste de Jarque-Bera, não se rejeita a hipótese que os resíduos se comportam como um ruído branco.
...
# ANÁLISE: Quase todas as autocorrelações dos resíduos estão dentro dos limites - indicando que os resíduos se comportam como um ruído branco.
# P-valor do teste de Ljung-Box é maior que o nível de significância de 5% (0.05).
# Pode-se concluir pela não rejeição da hipótese nula (que os resíduos são indepedentementes distribuídos).
# Portanto, segundo o teste de Ljung-Box, não se rejeita a hipótese que os resíduos se comportam como um ruído branco.
# P-valor do teste de Jarque-Bera é maior que o nível de significância de 5% (0.05).
# Pode-se concluir pela não rejeição da hipótese nula (que os resíduos são normalmente distribuídos).
# Portanto, segundo o teste de Jarque-Bera, não se rejeita a hipótese que os resíduos se comportam como um ruído branco.
...
# P-valor do teste de Ljung-Box é menor que o nível de significância de 5% (0.05).
# Pode-se concluir pela rejeição da hipótese nula (que os resíduos são indepedentementes distribuídos).
# Portanto, segundo o teste de Ljung-Box, rejeita-se a hipótese que os resíduos se comportam como um ruído branco.
...
# SARIMA(0,0,0)(2,1,2)12 teve melhor performance / menor BIC, RSME, MAPE e Theil's U.
# ETS teve a segunda melhor performance / terceiro menor BIC e segundo menor RSME, MAPE e Theil's U.
# TSLM teve a terceira melhor performance / segundo menor BIC e terceiro menor RSME, MAPE e Theil's U.
...
# Forecast de ETS - que tem parecidos RSME, MAPE e Theil's U, mas não passou no teste Ljung-Box de distribuição independente dos resíduos.
