...
# DECISÃO: # DECISÃO: Tirar a Primeira Diferença da Série Original.
...
# Aplicando a defasagem da sazonalidade (12 períodos) como regressor
...
# Splits / Série de treinamento (464 observações) / Série de teste (24 observações / frequência = 12 x maior AR/MA da ordem selecionada mais adequada do modelo SARIMA = 2)
...
# ANÁLISE: Random Forest obteve menor RSME, MAPE e Theil's U que os demais modelos - exceto o SARIMA(0,0,0)(2,1,2)12 e o ETS.
