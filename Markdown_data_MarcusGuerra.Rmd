...
ETS teve a segunda melhor performance / terceiro menor BIC e segundo menor RSME, MAPE e Theil's U. Registre-se que essa modelagem não passou no teste Ljung-Box de distribuição independente dos resíduos.\

TSLM teve a terceira melhor performance / segundo menor BIC e terceiro menor RSME, MAPE e Theil's U. Registre-se que essa modelagem não passou no teste Ljung-Box de distribuição independente dos resíduos.
